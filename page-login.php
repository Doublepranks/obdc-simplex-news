		...
		<div class="auth-container">
			<div class="auth-card">
				<header class="auth-card__header">
					...
					<p class="auth-card__subtitle"><?php esc_html_e( 'Faça login para acessar sua conta.', 'obdc-simplex-news' ); ?></p>
				</header>
				...
				<form method="post" class="auth-form" action="">
					...
					<div class="form-actions">
						<button type="submit" class="btn btn--primary"><?php esc_html_e( 'Entrar', 'obdc-simplex-news' ); ?></button>
					</div>
				</form>

				<div class="auth-footer">
					<p><a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Esqueceu sua senha?', 'obdc-simplex-news' ); ?></a></p>
					<p><?php esc_html_e( 'Ainda não tem uma conta?', 'obdc-simplex-news' ); ?> <a href="/register"><?php esc_html_e( 'Cadastrar', 'obdc-simplex-news' ); ?></a></p>
				</div>
			</div>
		</div>
	</div>
