			...
			<div class="register-card">
				<header class="register-card__header">
					...
					<p class="register-card__subtitle">
						<?php esc_html_e('Junte-se à nossa comunidade para acessar recursos exclusivos.', 'obdc-simplex-news'); ?>
					</p>
				</header>

				<?php if ($success): ?>
					<div class="register-message register-message--success">
						<p><strong><?php esc_html_e('Cadastro realizado com sucesso!', 'obdc-simplex-news'); ?></strong>
						</p>
						<p><?php esc_html_e('Verifique seu e-mail para obter sua senha e acessar sua conta.', 'obdc-simplex-news'); ?>
						</p>
						<div class="register-actions">
							<a href="<?php echo esc_url(wp_login_url()); ?>"
								class="btn btn--primary"><?php esc_html_e('Fazer Login', 'obdc-simplex-news'); ?></a>
						</div>
					</div>
				<?php else: ?>
					...
					<form method="post" class="register-form" action="">
						<div class="form-group">
							...
							<input type="text" name="username" id="username"
								value="<?php echo isset($username) ? esc_attr($username) : ''; ?>" required>
						</div>

						<div class="form-group">
							<label for="email"><?php esc_html_e('E-mail', 'obdc-simplex-news'); ?></label>
							<input type="email" name="email" id="email"
								value="<?php echo isset($email) ? esc_attr($email) : ''; ?>" required>
							<p class="form-hint">
								<?php esc_html_e('Uma senha será enviada para o seu endereço de e-mail.', 'obdc-simplex-news'); ?>
							</p>
						</div>
						...
						<div class="form-actions">
							<button type="submit"
								class="btn btn--primary"><?php esc_html_e('Cadastrar', 'obdc-simplex-news'); ?></button>
						</div>
					</form>

					<div class="register-footer">
						<p><?php esc_html_e('Já tem uma conta?', 'obdc-simplex-news'); ?> <a
								href="<?php echo esc_url(wp_login_url()); ?>"><?php esc_html_e('Entrar', 'obdc-simplex-news'); ?></a>
						</p>
					</div>
